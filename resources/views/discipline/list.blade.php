...
@section('content') 
    ...
    <div class="bg-white p-8 rounded-md w-full h-full">
        <div class=" flex items-center justify-between pb-6">
            <div>
                <h2 class="text-gray-600 font-semibold">Kỷ luật</h2>
            </div>

            {{-- navbar --}}
            <div class="flex lg:ml-40 ml-10 space-x-8">
                {{-- search --}}
                <form action="/discipline/search" method="POST">
                    @csrf
                ...
                {{-- add --}}
                <form action="/discipline/add" method="get">
                    @csrf
                ...
                <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
                    ...
                    <table class="min-w-full leading-normal">
                        <thead>
                            <tr>
                                <th
                                    class="px-5 py-3 border-b-2 border-gray-200 bg-red-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                    ID
                                </th>
                                <th
                                    class="px-5 py-3 border-b-2 border-gray-200 bg-red-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                        ...
                        <tbody>
                            {!! \App\Helpers\disciplineHelper::discipline_list($disciplines) !!}
                        </tbody>
                    </table>
