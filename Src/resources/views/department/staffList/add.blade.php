                ...
                <div class="grid grid-cols-3 gap-4 mt-8">
                    <div class="col-span-1 ml-2">
                        <div class="flex items-center mt-3">
                            ...
                            class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                <option selected hidden readonly>Chọn Nhân viên</option>
                    ...
                    <div class="col-span-1 ml-2">
                        <div class="flex items-center mt-3">
                            ...
                            class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                <option selected hidden readonly>Chọn Chức vụ</option>
                    ...
                    <div class="col-span-1 ml-2">
                        <div class="flex items-center mt-3">
                            <select name="degree" 
                            class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                <option selected hidden readonly>Chọn Trình độ</option>
